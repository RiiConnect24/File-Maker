...
def get_accuweather_api(list, key):
    ...
    tomorrow[key][0] = int(forecast[2][5][4].text)
...
def make_long_forecast_table(list):
    ...
    for key in list.keys():
        if matches_country_code(list, key) and get_region(list, key) != '':
            ...
            long_forecast_table["5day_tempc_high_1_%s" % numbers] = s8(week[key][11])  # 5-Day forecast day 1 high temperature in Celsius
            long_forecast_table["5day_tempc_low_1_%s" % numbers] = s8(week[key][10])  # 5-Day forecast day 1 low temperature in Celsius
            long_forecast_table["5day_tempf_high_1_%s" % numbers] = s8(week[key][1])  # 5-Day forecast day 1 high temperature in Fahrenheit
            long_forecast_table["5day_tempf_low_1_%s" % numbers] = s8(week[key][0])  # 5-Day forecast day 1 low temperature in Fahrenheit
            ...
            long_forecast_table["5day_tempc_high_2_%s" % numbers] = s8(week[key][13])  # 5-Day forecast day 2 high temperature in Celsius
            long_forecast_table["5day_tempc_low_2_%s" % numbers] = s8(week[key][12])  # 5-Day forecast day 2 low temperature in Celsius
            long_forecast_table["5day_tempf_high_2_%s" % numbers] = s8(week[key][3])  # 5-Day forecast day 2 high temperature in Fahrenheit
            long_forecast_table["5day_tempf_low_2_%s" % numbers] = s8(week[key][2])  # 5-Day forecast day 2 low temperature in Fahrenheit
            ...
            long_forecast_table["5day_tempc_high_3_%s" % numbers] = s8(week[key][15])  # 5-Day forecast day 3 high temperature in Celsius
            long_forecast_table["5day_tempc_low_3_%s" % numbers] = s8(week[key][14])  # 5-Day forecast day 3 low temperature in Celsius
            long_forecast_table["5day_tempf_high_3_%s" % numbers] = s8(week[key][5])  # 5-Day forecast day 3 high temperature in Fahrenheit
            long_forecast_table["5day_tempf_low_3_%s" % numbers] = s8(week[key][4])  # 5-Day forecast day 3 low temperature in Fahrenheit
            ...
            long_forecast_table["5day_tempc_high_4_%s" % numbers] = s8(week[key][17])  # 5-Day forecast day 4 high temperature in Celsius
            long_forecast_table["5day_tempc_low_4_%s" % numbers] = s8(week[key][16])  # 5-Day forecast day 4 low temperature in Celsius
            long_forecast_table["5day_tempf_high_4_%s" % numbers] = s8(week[key][7])  # 5-Day forecast day 4 high temperature in Fahrenheit
            long_forecast_table["5day_tempf_low_4_%s" % numbers] = s8(week[key][6])  # 5-Day forecast day 4 low temperature in Fahrenheit
            ...
            long_forecast_table["5day_tempc_high_5_%s" % numbers] = s8(week[key][29])  # 5-Day forecast day 5 high temperature in Celsius
            long_forecast_table["5day_tempc_low_5_%s" % numbers] = s8(week[key][30])  # 5-Day forecast day 5 low temperature in Celsius
            long_forecast_table["5day_tempf_high_5_%s" % numbers] = s8(week[key][25])  # 5-Day forecast day 5 high temperature in Fahrenheit
            long_forecast_table["5day_tempf_low_5_%s" % numbers] = s8(week[key][26])  # 5-Day forecast day 5 low temperature in Fahrenheit
            ...
            long_forecast_table["5day_tempc_high_6_%s" % numbers] = s8(week[key][31])  # 5-Day forecast day 6 high temperature in Celsius (JAPAN ONLY)
            long_forecast_table["5day_tempc_low_6_%s" % numbers] = s8(week[key][32])  # 5-Day forecast day 6 low temperature in Celsius (JAPAN ONLY)
            long_forecast_table["5day_tempf_high_6_%s" % numbers] = s8(week[key][27])  # 5-Day forecast day 6 high temperature in Fahrenheit (JAPAN ONLY)
            long_forecast_table["5day_tempf_low_6_%s" % numbers] = s8(week[key][28])  # 5-Day forecast day 6 low temperature in Fahrenheit (JAPAN ONLY)

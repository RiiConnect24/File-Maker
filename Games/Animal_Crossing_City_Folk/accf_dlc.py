...
def item_name(language):
    if (language == "Korean" or "Japanese"):
        name = input("Please enter the item name in %s: " % language).decode(
...
def make_item_bin():
    ...
    item["item_name_north_american_english"] = item_name(
        "North American English")  # The name of the item in North American English.
    item["item_name_north_american_spanish"] = item_name(
        "North American Spanish")  # The name of the item in North American Spanish.
    item["item_name_north_american_french"] = item_name(
        "North American French")  # The name of the item in North American French.

...
print "2 - Large"
print "\n"
aquarium_size = raw_input('Enter Selection: ')
print "GLASS TYPE"
print "0 - Normal"
print "1 - Gift 1"
print "2 - Gift 2"
...
print "\n"
glass_type = raw_input('Enter Selection : ')
print "FLOOR TYPE"
print "0 - River Bed"
print "1 - Sand"
print "2 - White Sand"
...
print "4 - Gravel 2"
print "\n"
floor_type = raw_input('Enter Selection : ')
...
print "\n"
background_type = raw_input('Enter Selection : ')
print "LIGHT TYPE"
print "0 - Normal"
...
print "6 - Spotted"
print "\n"
light_type = raw_input('Enter Selection : ')
print "\nSPECIAL DATE 1"
specialdate1_month = raw_input('Enter Month Number : ')
specialdate1_day = raw_input('Enter Day Number : ')
print "\nSPECIAL DATE 2"
specialdate2_month = raw_input('Enter Month Number : ')
specialdate2_day = raw_input('Enter Day Number : ')
print "\nSPECIAL DATE 3"
specialdate3_month = raw_input('Enter Month Number : ')
specialdate3_day = raw_input('Enter Day Number : ')
print "\n"
...
if raw_input('Would you like to add fish? [y/n] ') is 'y':
    amnt = int(raw_input('Enter amount of fish to add [MAX 15]: '))
    if amnt <= 15:
        print "\n"
        ...
        print "\n"
        for i in range(amnt):
            sel = int(raw_input('Selection %s: ' % i))
            if sel < 40:
